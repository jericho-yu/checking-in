...
const generateExcel = async function (finalStatisticStore = {}, filename = '') {
    ...
    // 设置表头
    worksheet.columns = [
        { header: '姓名', key: 'name', width: 9, font: { color: { argb: '000000' } } },
        {
            header: '工作日\r\n加班',
            key: 'workdayOvertime',
            width: 9,
        ...
        { header: '年假', key: 'annualLeave', width: 9, font: { color: { argb: '0000FF' } } },
        { header: '陪产假', key: 'paternityLeave', width: 9, font: { color: { argb: '0000FF' } } },
        {
            header: '调休',
        ...
        { header: '事假', key: 'personalLeave', width: 9, font: { color: { argb: '0000FF' } } },
        { header: '病假', key: 'sickLeave', width: 9, font: { color: { argb: '0000FF' } } },
        { header: '旷工', key: 'absenteeism', width: 9, font: { color: { argb: 'FF0000' } } },
        {
            header: '上班\r\n缺卡',
            key: 'missingClockIn',
            width: 9,
        ...
        { header: '上班\r\n迟到', key: 'lateClockIn', width: 9, font: { color: { argb: 'FF0000' } } },
        {
            header: '下班\r\n早退',
            key: 'earlyClockOut',
            width: 9,
...
const clearHoliday3Dates = () => holiday3Dates.value = []; holiday3DatesProxy.value = []
...
const clearExWorkdayDates = () => exWorkdayDates.value = []; exWorkdayDatesProxy.value = []
...
const clearExHolidayDates = () => exHolidayDates.value = []; exHolidayDatesProxy.value = []
...
const clearHolidayDates = () => holidayDates.value = []; holidayDatesProxy.value = []
</script>
